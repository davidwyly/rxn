...
class Filecache
{
    ...
    {
        $directory = __DIR__ . "Filecache.class.php/" . $this->config->fileCacheDirectory;
        if (!file_exists($directory)) {
            throw new \Exception("Cache $directory doesn't exist; it may need to be created", 500);
        }
        $this->directory = realpath(__DIR__ . "Filecache.class.php/" . $this->config->fileCacheDirectory);
    }
