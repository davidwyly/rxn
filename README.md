...
- [ ] File caching
- [ ] ORM autowiring *(where relationships are derived from database structure and foreign keys)*
- [ ] Dependency injection autowiring *(where constructor parameters are injected using type-hinting)*
